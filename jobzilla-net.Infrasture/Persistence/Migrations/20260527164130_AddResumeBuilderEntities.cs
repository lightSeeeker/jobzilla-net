...
{
    /// <inheritdoc />
    public partial class AddResumeBuilderEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidateSocialLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CandidateSocialLinks_CandidateProfiles_CandidateProfileId",
                        column: x => x.CandidateProfileId,
                        principalTable: "CandidateProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "A clean, professional template suitable for all industries.", true, false, "Standard Professional", null, "Standard", null },
                    { 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "A sleek, modern design with vibrant accents for creative roles.", true, false, "Modern Creative", null, "Modern", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateSocialLinks_CandidateProfileId",
                table: "CandidateSocialLinks",
                column: "CandidateProfileId");
        }
