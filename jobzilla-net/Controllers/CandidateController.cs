...
using jobzilla_net.Models.Candidate;
...
public class CandidateController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var viewModel = new CandidateOverviewViewModel
        {
            Overview = overview
        };
    ...
    public async Task<IActionResult> AppliedJobs(int page = 1)
    {
        ...
        var viewModel = new CandidateAppliedJobsViewModel
        {
    ...
    public async Task<IActionResult> SavedJobs(int page = 1)
    {
        ...
        var viewModel = new CandidateSavedJobsViewModel
        {
            SavedJobs = savedJobs
        };
    ...
    public async Task<IActionResult> Resumes()
    {
        ...
        var viewModel = new CandidateResumesViewModel
        {
            Resumes = resumes
        };
